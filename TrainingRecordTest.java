...
public class TrainingRecordTest {
    ...
    public void testRemoveEntry() {
        ...
        Entry entry = new Entry("Alice", 1, 1, 2022, 0, 30, 0, 0);
        tr.addEntry(entry);
        tr.RemoveEntry(1, 1, 2022, "Alice");
        assertEquals(1, tr.getNumberOfEntries());
        assertEquals(tr.FindAllByDate(1, 1, 2022).length(), 1);
    }
}
